...
if __name__ == "__main__":
    ...
    documents = NewPetFormatImporter("/Users/jannic/Developer/Bachelorarbeit/pet-baselines/api/new_data/all.new.jsonl").do_import()
    exporter = PetDictExporter()
    document = exporter.export_document(documents[0])
    print(document)